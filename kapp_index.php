...
<div id="set_topbar">
    ...
    <span id="set_bartxt"><a ser="<?=KAPP_URL_T_?>/setup/">SETUP</a></span>
</div>
...
} else if( $_POST['mode'] =='Kapp_ReSet' ){ //m_("kapp_index mode: " . $_POST['mode']);
...
function db_create_screen( $setup_type ){ // 'kapp_dbcon.php' 없어서 이것을 생성해야 하는 처음 실행 루틴.
	...
	<div class='HeadTitle01AX'>   
		<P class='on' title=' kapp_dbcon.php - file Create Page'><b>K-APP Generator $setup_type Manager</b></P>   
	</div>   <br><br>
	...
	<div>      
		...
		<div class='menu1A'><input type='text' name='db_host' value='localhost' readonly title='it is standard - db_host' style='width:$Xwidth;height:$Xheight;' placeholder='Please enter a Host Name'></div>  
		...
		<div class='menu1A'><input type='text' name='db_user' value='' style='width:$Xwidth;height:$Xheight;' placeholder='Please enter a DB User ID'></div>  
		<div class='blankA'> </div>  
		...
		<div class='menu1A'><input type='text' name='admin_email' value='' style='width:$Xwidth;height:$Xheight;' placeholder='Please enter a Admin Email'></div>  
