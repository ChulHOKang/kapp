...
<?php } ?>
			...
			<img src='<?=KAPP_URL_T_?>/logo/land25.png' style='width:24px;height:22px;'>.Program Permissions</a></li>
			...
			<li style='font-size:18;color:#666666;height:18px;line-height:1; text-align:left;'>
			<a onclick="run_on();" href='<?=KAPP_URL_T_?>/kapp_program_list_ai.php' target='run_menu'>
