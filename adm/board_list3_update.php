...
function run_funcA(infor){
	...
	document.update_form.action='../menu/index_bbs.php?infor='+infor;
          ...
          <table border="0" cellpadding="0" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" bgcolor="#FFFFFF">
            <tr>
              ...
              <td width="77%" bgcolor="#66ffff">
				<a href='index.php?infor=<?=$mf[0]?>' target='_BLANK'><b><?=$mf[2]?> -> <font color=blue > Click Run</font></b></a></td>
            </tr>
             <tr>
...
<?php
			if( $mf[46] == '0' ) 	$vR = "Guest";
			else if ($mf[46] == '1' ) $vR = "Member";
			else if ($mf[46] == '2' ) $vR = "Member Admin";
			else if ($mf[46] == '3' ) $vR = "System Admin";
			else $vR = "Guest";
		  
?>	  
				<option value='<?=$mf[46]?>' selected ><?=$vR?></option>
				<option value='0'>Guest All</option>
...
<?php
			if( $mf[47] == '0' ) 	$vW = "Guest";
			else if ($mf[47] == '1' ) $vW="Member";
			else if ($mf[47] == '2' ) $vW="Member Admin";
			else if ($mf[47] == '3' ) $vW="System Admin";
			else $vW = "Guest";
?>	  
          <tr>
