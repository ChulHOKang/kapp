...
//$sql = " select sum(po_point) as cnt
...
<?php
		...
		$row2 = sql_fetch( $sql2 );
        echo '&nbsp;[' . $H_ID .'] Total Point : ' . number_format($row2['sum_point']) . ')';
?>
	</caption>
