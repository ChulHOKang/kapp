<?php
	...
	/*
	  treebom_updw_curl_ailinkapp.php : /t/menu/treebom_updw_new_menu.php - update 시에 실행. 중요.
	  작업 결과 : 성공, 2023-07-27
	*/
	...
	//--------------------------------------------------------
    if( isset($tabData) ){
        $message = '_api treebom_updw_curl_ailinkapp data 전달 완료';
    } else {
        $message = '_api treebom_updw_curl_ailinkapp data 전달 실패';
    }
