...
if( $w == '') {
		...
		$sql = " insert into {$tkher['tkher_member_table']} set mb_id = '{$mb_id}', mb_password = '".get_encrypt_stringA($mb_password)."', mb_name = '{$mb_name}', mb_nick = '{$mb_nick}', mb_nick_date = '".KAPP_TIME_YMD."', mb_email_certify = '".KAPP_TIME_YMDHIS."', mb_email = '{$mb_email}', mb_today_login = '".KAPP_TIME_YMDHIS."', mb_datetime = '".KAPP_TIME_YMDHIS."', mb_ip = '{$_SERVER['REMOTE_ADDR']}', mb_level = '2', mb_sn = 'SignUp', mb_recommend = '{$mb_recommend}', mb_login_ip = '{$_SERVER['REMOTE_ADDR']}', mb_mailling = '{$mb_mailling}', mb_sms = '{$mb_sms}' {$sql_certify} ";
