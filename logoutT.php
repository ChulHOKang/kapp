<?php
	...
	if( get_session("urllink_login_type") == "Google") { //$_SESSION['urllink_login_type']
		...
		echo "<script>top.location.href=' https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=https://biogplus.com/kapp/'</script>";
