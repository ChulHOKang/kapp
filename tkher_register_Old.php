...
<div class="mbskin">
	...
	<!-- <br>회원가입약관 및 개인정보처리방침안내의 내용에 동의하셔야 회원가입 하실 수 있습니다.! --></p>
    ...
    <section id="fregister_private">
        ...
        <div class="tbl_head01 tbl_wrap">
            <table>
                ...
                <tbody>
                <tr>
                    <td>Identify and verify your identity <!-- <br>(이용자 식별 및 본인여부 확인) --></td>
                    <td>ID, Name, Password <!-- <br>(아이디, 이름, 비밀번호) --></td>
                    <td>Until membership is canceled <!-- <br>(회원 탈퇴 시까지) --></td>
                </tr>
                <tr>
                    <td>Notice of Customer Service Use<!-- <br>(고객서비스 이용에 관한 통지) -->,<br>User identification for CS response <!-- <br>(CS대응을 위한 이용자 식별) --></td>
                    <td>Contact, E-Mail, Phone<!--  <br>( 연락처, 이메일, 휴대전화번호 ) --></td>
                    <td>Until membership is canceled <!-- <br>(회원 탈퇴 시까지) --></td>
                </tr>
                </tbody>
            </table>
        ...
        <fieldset class="fregister_agree" align=center>
            ...
            <label for="agree21">I agree to the contents of the Privacy Policy Guide.<!--  <br>(개인정보처리방침안내의 내용에 동의합니다.) --> </label>
        </fieldset>
    </section>
