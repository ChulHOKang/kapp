...
if( $w == "") {
    ...
    $url = KAPP_URL;
    if( !$agree ) {
        alert('You must be signed in to the membership agreement before you can join.', KAPP_URL_T_ . '/tkher_register_.php');
...
?>
    ...
    var tkher_editor = "<?php echo ($config['kapp_editor'] && $board['bo_use_dhtml_editor'])?$config['kapp_editor']:''; ?>";
...
<?php } ?>
    ...
    <div class="mbskin">
        <form name="fregisterform" id="fregisterform" action="<?php echo $register_action_url ?>" onsubmit="return fregisterform_submit(this,'<?=$register_action_url?>');" method="post" enctype="multipart/form-data" autocomplete="off">
            <!-- w:<?php echo $w ?> -->
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id"
                                class="frm_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" <?php echo $required ?> <?php echo $readonly ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php }  ?>
                            <input type="hidden" name="old_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>">
                            <input type="email" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>"
                                id="reg_mb_email" required class="frm_input email required" size="50" maxlength="100">
                        </td>
                    </tr>
                    <tr>
                        <!-- <strong class="sound_only">필수</strong> -->
                        <th scope="row"><label>Password</label></th>
                        <td><input type="password" name="mb_password" id="reg_mb_password" class="frm_input <?php echo $required ?>" minlength="3" maxlength="20"
                                <?php echo $required ?>></td>
                    </tr>
                    <tr>
                        <th scope="row"><label>Password confirm</label></th>
                        <td><input type="password" name="mb_password_re" id="reg_mb_password_re" class="frm_input <?php echo $required ?>" minlength="3" maxlength="20"
                                <?php echo $required ?>></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?>
                                <?php echo $readonly; ?> class="frm_input <?php echo $required ?> <?php echo $readonly ?>">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>"
                                id="reg_mb_nick" required class="frm_input required nospace" maxlength="20">
...
<?php } ?>
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="mb_mailling" value="1" id="reg_mb_mailling" <?php echo ($w=='' || $member['mb_mailling'])?'checked':''; ?>> I would like to receive mail.
                        </td><!--  (정보 메일을 받겠습니다.) -->
                    </tr>
...
<?php } 
                    ...
                    <tr>
                        <th scope="row" oncontextmenu='return false' ondragstart='return false' onselectstart='return false'>Prevent autoenrollment</th>
                        <td oncontextmenu='return false' ondragstart='return false' onselectstart='return false'><br>
            ...
            <div class="btn_confirm">
                <input type="submit" value="<?php echo $w==''?'SignUp':'Change'; ?>" id="btn_submit" class="btn_submit" accesskey="s">
            
                <!-- <input type="button" onclick="javascript:fregisterform_submit(this,'<?=$register_action_url?>');" value="<?php echo $w==''?'Sign-Up':'Change'; ?>" id="btn_submit" class="btn_submit" accesskey="s"> -->
