...
//echo "<script>alert('alert.php ------------------------------------------ ');</script>";//2번콜..
if($error) {
    $tkher['title'] = "Error page 오류안내 페이지";
} else {
    $tkher['title'] = "Results page  결과안내 페이지";
}
...
if($error) {
    $header2 = "The following items have errors. 다음 항목에 오류가 있습니다.";
} else {
    $header2 = "Please check the following: 다음 내용을 확인해 주세요.";
}
?>
...
<div id="validation_check">
    ...
    <div class="btn_confirm">
        <a href="<?php echo $url ?>">go back 돌아가기</a>
    </div>
    <?php } ?>
