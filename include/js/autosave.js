...
$(function(){
    ...
    $("#btn_autosave").click(function(){
        if ($("#autosave_pop").is(":hidden")) {
            $.get(js_url+"/ajax.autosavelist.php", function(data){
                //alert(data);
    ...
    $(document).on( "click", ".autosave_load", function(){
        ...
        $.get(js_url+"/ajax.autosaveload.php", {"as_id":as_id}, function(data){
    ...
    $(document).on( "click", ".autosave_del", function(){
        var $li = $(this).parents("li");
        var as_id = $li.data("as_id");
        $.get(js_url+"/ajax.autosavedel.php", {"as_id":as_id}, function(data){
            if (data == -1) {
