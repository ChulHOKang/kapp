...
<script>
	function program_run_pgA(){
		thisform = document.makeform;
		var pg_code			= document.makeform.pg_code.value;
		var grant_write		= document.makeform.grant_write.value;
		var H_LEV			= document.makeform.H_LEV.value;
			alert("pg_code: " + pg_code + ", " + grant_write +", "+ H_LEV);
			//dao_1768010782, 2, 8
...
?>
	...
	<div>
		<P onclick="javascript:home_func(this,'<?=$pg_code?>')" class="HeadTitle02AX" title='pg:<?=$pg_code?>, tab:<?=$tab_enm?> '><?=$pg_name?></P>
	</div>
				...
				if( $fld[3] == "TEXT" ) {
					echo " <div class='menu1Area' ><p>$fld[2]</p><textarea name='$fld[1]' placeholder='Please enter your $fld[2]!' style='width:$Xwidth;height:$Text_height;'></textarea></div>";
						...
						if( $typeX == "1" ) { // radio button
							...
							echo " <div class='menu1T' ><span style='width:$Xwidth;height:$Xheight;'>$fld[2]</span></div> ";
							//echo " <div class='menu1A'><input type=text name='$fld_enmX' onclick=\"javascript:kapp_dataManager.popup_call( this, '$if_dataPG', '$popX', '$i')\" style='width:$Xwidth;height:$Xheight;' placeholder='PopUp Window. Please enter a $fld[2].'></div> ";
							echo " <div class='menu1A'><input type=text name='$fld_enmX' onclick=\"javascript:kapp_dataManager.popup_call( this, $i)\" style='width:$Xwidth;height:$Xheight;' placeholder='PopUp Window. Please enter a $fld[2].'></div> ";
							echo " <div class='blankA'> </div> ";
						} else {
							echo " <div class='menu1T' ><span style='width:$Xwidth;height:$Xheight;'>$fld[2]</span></div> ";
...
?>
		...
		<!-- <input type="button" value="Submit" onclick="kapp_dataManager.program_run_pg( this, '<?=$i?>','<?=$iftypeX?>')" class='kapp_btn_bo02'> -->
		<input type="button" value="Submit" onclick="javascript:kapp_dataManager.program_run_pg(this);" class='kapp_btn_bo02' title='write submit button ' >
...
?>
		<input type='button' value='List' onclick="javascript:kapp_dataManager.table_data_list( this, '<?=$pg_code?>');" class="kapp_btn_bo02">
</form>
<br>
