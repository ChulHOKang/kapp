  <?php
	include_once('./kapp_start_necessary_TT.php');	//include_once('./tkher_start_necessary.php');
	$H_ID	= get_session("ss_mb_id");	$H_LEV=$member['mb_level'];  $ip = $_SERVER['REMOTE_ADDR'];

   /*
      index_kapp.php <- index.php copy Test
	  - include : kapp_start_necessary_TT.php
	  - iframe  : indexTT_kapp.php
      ...
      ./tree_menu_guest.php : Guest View Mobile <- /t/menu/tree_menu_updateM2.php 을 copy
     ...
     //m_($_SERVER['SCRIPT_FILENAME'] . ", count:" . $cnt . ", r:" . $r[$cnt-1]); 
	   -> "/var/www/html/t/index_kapp.php, count:6, r:index_kapp.php"
   -------------------------------------------------------- */
   ...
   $cnt= count($r);
   $_url = "./" . $r[$cnt-1]; // $_url : index_kapp.php
...
function submit_runX( mid, sys_pg, sys_menu, sys_submenu, num, pg, jong, title_, link_, target_){ 
	...
	{ 
		...
		document.click_run.submit();     
	}else if (link_.indexOf( 'contents_view_menuD.php')>=0 ) { 
...
function submit_run( mid, sys_pg, sys_menu, sys_submenu, num, pg, jong, title_, link_, target_){ 
	...
	if( runtype=='update'){
		...
		document.click_run.submit();     
	} else if(runtype=='' || runtype=='run'){			//alert('tree_menu_guest --- runtype:'+runtype);
		if (pg.indexOf( 'contents_view_menuD.php')>=0 ) { 
			document.click_run.target='run_menu';  
			document.click_run.target_.value='run_menu'; 
			document.click_run.action= './menu/cratree_coinadd_menu.php'; 
			document.click_run.submit();  
		...
		if (link_.indexOf( 'contents_view_menuD.php')>=0 ) { 
			document.click_run.target='run_menu';  
			document.click_run.target_.value='run_menu'; 
			document.click_run.action= './menu/cratree_coinadd_menu.php'; 
			document.click_run.submit();  
	...
	function arunA( runtype ){ //menu_change
		...
		if( runtype=='insert' ){
			...
			document.click_run.target='run_menu';
			document.click_run.action = './menu/index.php'; //cratree_my_list_menu.php
			document.click_run.submit();
...
<div class="header"><!-- start : header -->
	...
	<div id="mySidenav" class="sidenav">
		  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a><!-- X 버턴 -->
			<center>
			<a href='<?=$_url?>' target='_top'><img src="/logo/logo.png" title='K-App - home:<?=$_url?>'></a>
		<?php
			$run_target='run_menu'; // $run_target='url_link_tree_solpa_user_r';
			$img_v="<img src='/logo/pizza.png' width='15' height='15'>";
		?>
		<HR width="100%" align="center" style="color:yellow; background-color:yellow; height:2px; border:none" />
		<li style="color:cyan; background-color:black; height:21px; border:none">K-App User: <?=$H_ID?></li>
		<HR width="100%" align="center" style="color:yellow; background-color:yellow; height:2px; border:none" />

		<!-- <li style='font-size:18;color:#666666;height:21px;line-height:1; text-align:left' title='table design' ><a onclick="run_on();" href='./table30m.php' target='run_menu' title='table design'>1.<img src='/logo/pizza.png' width='15' height='15'>Table Design</a></li> --><!-- 2023-10-4 -->
		<li style='font-size:18;color:#666666;height:21px;line-height:1; text-align:left' title='table design for high level' ><a onclick="run_on();" href='./table30m_A.php' target='run_menu' title='table design for High Level'>1.<img src='/logo/pizza.png' width='15' height='15'>Table Design</a></li>

		<li style='font-size:18;color:#666666;height:21px;line-height:1; text-align:left'><a onclick="run_on();" href='./table10i.php' target='run_menu'>2.<img src='/logo/Uleaf.png' width='15' height='15'>Table List</a></li>
		<li style='font-size:18;color:#666666;height:21px;line-height:1; text-align:left'><a onclick="run_on();" href='./table10u1_PC.php' target='run_menu'>3.<img src='/logo/land25.png' width='15' height='15'>Table Permissions</a></li>
		<li style='font-size:18;color:#666666;height:21px;line-height:1; text-align:left'><a onclick="run_on();" href='./app_pg50RC.php' target='run_menu'>4.<img src='/logo/appmaker.jpg' width='15' height='15'>Program Create</a></li>
		<li style='font-size:18;color:#666666;height:21px;line-height:1; text-align:left'><a onclick="run_on();" href='./app_pg50RU.php' target='run_menu'>5.<img src='/logo/ship.png' width='15' height='15'>Program Upgrade</a></li>
		<li style='font-size:18;color:#666666;height:21px;line-height:1; text-align:left'><a onclick="run_on();" href='./table_relationA.php' target='run_menu'>6.<img src='/logo/seed.png' width='15' height='15'>Table Relationship</a></li>
		<li style='font-size:18;color:#666666;height:21px;line-height:1; text-align:left'><a onclick="run_on();" href='./program_list3.php' target='run_menu'>7.<img src='/logo/seedX.png' width='15' height='15'>Program List A</a></li>
		<li style='font-size:18;color:#666666;height:21px;line-height:1; text-align:left'><a onclick="run_on();" href='./program_pglist.php' target='run_menu'>8.<img src='/logo/berry.png' width='15' height='15'>Program List B</a></li>
		<li style='font-size:18;color:cyan;height:21px;line-height:1; text-align:left'><a onclick="run_on();" href='./menu/index.php' target='run_menu'>p.<img src='/logo/leaf.png' width='15' height='15'>K-Tree</a></li>

		<!-- <li style="color:cyan; background-color:black; height:21px; border:none; text-align:left"><a href='./program_pglist.php' target='run_menu'><img src='/logo/berry.png' width='15' height='15'>8.Program List B</a></li> -->
		...
		</li><!-- 작동하지 않으면 팝업 창을 차단 해제하십시오. -->
		<!-- <li style='font-size:9;color:#666666;height:9px;line-height:1'>
		We call it mining to register in the tree menu.
		</li> -->
...
<div style="background-color:black;">
	<span style="font-size:24px;cursor:pointer;color:cyan;background-color:black;" onclick="openNav()" title='tree menu list'>&#9776; <?=$kapp?><img src="/logo/logo120-120.png" align='center' style="margin:0px auto;height:24px;" title='K-App'></span><!-- 트리출력버턴 -->
</div>

<center>

<?php
	$src = './indexTT_kapp.php?go_url=' . $_url; //$_url : index_kapp.php
?>
...
<?php
	...
	//if( $_SESSION['sys_pg'] || $_POST['sys_pgS'] || $_REQUEST['sys_subtitS'] || $_REQUEST['open_mode'] == 'on' ) {
	if( $_REQUEST['open_mode'] == 'on' ) {
	  echo "<script>document.getElementById('mySidenav').style.width = '250px';</script>";
	}
   //if($_REQUEST['open_mode'] == 'on') echo "<script>openNav(); </script>";
...
function funcrs($rsr_submenu, $run_target) {
	...
	while( $rs2 = sql_fetch_array($result)) {
		...
		$target_= $run_target; 
		// background-color:$bgcolor; 추가: 2021-10-09
		if ( $rssys_cnt == 0 ) {
			$div_open = "";
