...
function paging( $link, $total, $page, $size){
	...
	*/
	...
	if( $page > $page_num ) {
		echo("<a href='javascript:page_move( this, 1)'>[First]</a><span>.</span>");
	} else {
	...
	if( $page > $page_num ) {
		...
		//echo("<a href='javascript:page_move( this, $back_page)' ><img src=./include/img/btn/btn_prev.png width=30 title='previous'></a>");
		echo("<a href='javascript:page_move( this, $back_page)' >[Prev]</a><span>.</span>");
	} else {
	...
	for( $i=$first_page; $i <= $last_page; $i++ ){
		...
		else         { echo("<a href='javascript:page_move( this, $i)'>$i</a><span>.</span>"); }
	}
	if( $last_page < $total_page){
		$next_page=$last_page+1;
		echo("<a href='javascript:page_move( this, $next_page)'>[Next]</a><span>.</span>");
		//echo("<a href='javascript:page_move( this, $next_page)'><img src=./include/img/btn/btn_next.png width=30 title='B Next Page'></a>");
	}else { 
		//echo("<img src=./include/img/btn/btn_next.png width=30 title='Btn Next Page'>");
		//echo("<span>[Next].</span>");
	}
	if( $last_page < $total_page){
		echo("<a href='javascript:page_move( this, $total_page)'>[Last]</a>");
	}else{
		echo("<span>[End]</span>");
