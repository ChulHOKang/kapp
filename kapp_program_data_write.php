...
?>
	...
	<div class="boardViewX">
		<div class="viewHeader">
			<span title='pg:kapp_program_dat_write'><?=$in_day?></span>
		</div>
...
<?php
		...
		//m_("item: ".$table_item_array);
		//item: |fld_1|일자|DATETIME|20@|fld_2|거래처|VARCHAR|15@|fld_3|구분|VARCHAR|15@|fld_4|상품|VARCHAR|50@|fld_5|규격|VARCHAR|15@|fld_6|수량|INT|12@|fld_7|단가|INT|12@|fld_8|금액|INT|12@|fld_9|세액|INT|12@|fld_10|합계|INT|12@|fld_11|메모|TEXT|255@
		...
		for( $i=0,$j=1; isset($list[$i]) && $list[$i] != ""; $i++, $j++ ){
			...
			if( isset($fld[1]) && $fld[1] != "seqno") { 
				$fld_enmX= $fld[1];
				if( $fld[3] == "TEXT" ) {
					echo " <div class='menu1Area' ><p>$fld[2]</p><textarea id='$fld[1]' name='$fld[1]' placeholder='Please enter your $fld[2]!' style='width:$Xwidth;height:$Text_height;'></textarea></div>";
							echo " <div class='blankA'> </div> ";
				} else if( $fld[3] == "TIME" ) {
							$tday=date("H:i:s");
							echo " <div class='menu1T' ><span style='width:$Xwidth;height:$Xheight;'>$fld[2]</span></div> ";
							echo " <div class='menu1A'><input type='$fld[3]' id='$fld[1]' name='$fld[1]' value='$tday' style='width:$Xwidth;height:$Xheight;' placeholder='Please enter a $fld[2].'></div> ";
							echo " <div class='blankA'> </div> ";
				} else if( $fld[3] == "DATE" ) { 
							$day=date("Y-m-d");
							echo " <div class='menu1T' ><span style='width:$Xwidth;height:$Xheight;'>$fld[2]</span></div> ";
							echo " <div class='menu1A'><input type='$fld[3]' id='$fld[1]' name='$fld[1]' value='$day' style='width:$Xwidth;height:$Xheight;' placeholder='Please enter a $fld[2].'></div> ";
							echo " <div class='blankA'> </div> ";
						...
						if( $typeX == "1" ) { // radio button
							...
							for ( $k=0; isset( $if_fld[$k]) && $if_fld[$k] != ""; $k++ ){
								echo	"<input type='radio' id='$fld[1]' name='" . $fld[1] . "' value='" . $if_fld[$k] . "' class='input1A'>" . $if_fld[$k] . " &nbsp;";
							}
								echo " </span></div> ";
								echo " <div class='blankA'> </div> ";
								...
								echo " <div class='radio1A'><span>";
							for ( $k=0; isset( $if_fld[$k]) && $if_fld[$k] != ""; $k++ ){
									echo	"<input type='Checkbox' id='$fld[1]' name='" . $fld[1] .  "[]'  value='" . $if_fld[$k] . "' >" . $if_fld[$k] . " &nbsp;";
							}
								echo " </span></div> ";
								echo " <div class='blankA'> </div> ";
								...
								echo	"<SELECT id='$fld[1]' NAME='$fld[1]' SIZE='1' style='border-style:;height:25;'>";
							for ( $k=0; isset( $if_fld[$k]) && $if_fld[$k] != ""; $k++ ){
							...
							echo " <div class='menu1T' ><span style='width:$Xwidth;height:$Xheight;'>$fld[2]</span></div> ";
							echo " <div class='menu1A'><span><input type='number' id='$fld[1]' name='$fld[1]' onClick='FUNC_$kkk5()' title='FUNC_$kkk5()' value='' style='width:$Xwidth;height:$Xheight;' placeholder='Please enter a $fld[2].'></span></div> ";
							echo " <div class='blankA'> </div> ";
							$kkk5++; // = $func_cnt;
						} else {
							echo " <div class='menu1T' ><span style='width:$Xwidth;height:$Xheight;'>$fld[2]</span></div> ";
							echo " <div class='menu1A'><input type='number' id='$fld[1]' name='$fld[1]' value='' style='width:$Xwidth;height:$Xheight;' placeholder='Please enter a $fld[2].' class=autom_subj></div> ";
							echo " <div class='blankA'> </div> ";
						}
				} else {
						...
						if( $typeX == "1" ) { // radio button
							...
							echo " <div class='menu1T' ><span style='width:$Xwidth;height:$Xheight;'>$fld[2]</span></div> ";
							echo " <div class='menu1A'><input type='PASSWORD' id='$fld[1]' name='$fld[1]' value='' style='width:$Xwidth;height:$Xheight;' placeholder='Please enter a $fld[2].'></div> ";
							echo " <div class='blankA'> </div> ";
						} else if( $typeX == "9" ) { // add file 
							echo " <div class='menu1T' ><span style='width:$Xwidth;height:$Xheight;'>$fld[2]</span></div> ";
							echo " <div class='File1A'>";
							echo " <input type='FILE' id='$fld[1]' name='$fld[1]' style='width:$Xwidth;height:$Xheight;' placeholder='Please enter a $fld[2].'> ";
							echo " </div> ";
							echo " <div class='blankA'> </div> ";
							...
							echo " <div class='menu1T' ><span style='width:$Xwidth;height:$Xheight;'>$fld[2]</span></div> ";
							echo " <div class='menu1A'><input type='text' id='$fld[1]' name='$fld[1]' value='' style='width:$Xwidth;height:$Xheight;' placeholder='Please enter a $fld[2].'></div> ";
							echo " <div class='blankA'> </div> ";
						}
				} //if( $fld[3] == "TEXT" ) {
			} else {	//if( $fld[1] != "seqno")
...
?>
		...
		<input type='hidden' id='relation_dataPG'	name='relation_dataPG'	value='<?=$relation_dataPG?>'>
		<input type='hidden' id='relation_typePG'	name='relation_typePG'	value='<?=$relation_typePG?>'>
