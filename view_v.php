						...
						<div class='workView workView$num'>
							<div class='cont'>
								<div class='workHeader'>
									<a href=\"javascript:void(0)\" class='whleft'><img src='./include/img/btn/btn_workLeft02.png' /></a>

									<p class='t02'>Group : $group_name</p>
									<p class='t02'>Title   : $jpg_name</p>
									<a href='javascript:void();' class='whright nextwork'><img src='./include/img/btn/btn_workRight01.png' /></a>
								</div>
								<div class='workImg'>
									<p><img src='./data/main_scroll_image/$row[jpg_file]' /></p>
									<!-- <p><img src='/cratree/$H_ID/$row[jpg_file]' /></p>
									<p><img src='/cratree/$H_ID/$row[jpg_file]' /></p> -->
								</div>
								<div class='info'>
									<ul>
