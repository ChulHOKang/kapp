...
$(function () {
	...
	document.getElementById('tit_et').addEventListener('click', function(e) {
		...
		timer = setTimeout(() => {
			switch(e.target.innerText){
				case 'Project' : title_func('group_name', 'kapp_program_list.php'); break;
				case 'User'    : title_func('userid', 'kapp_program_list.php'); break;
				case 'Program' : title_func('pg_name', 'kapp_program_list.php'); break;
				case 'Table'   : title_func('tab_hnm', 'kapp_program_list.php'); break;
				case 'Date'    : title_func('upday', 'kapp_program_list.php'); break;
				default        : title_func('', 'kapp_program_list.php'); break;
			}
		}, 250);
	});
	document.getElementById('tit_et').addEventListener('dblclick', function(e) {
		clearTimeout(timer);
		switch(e.target.innerText){
				case 'Project' : title_wfunc('group_name', 'kapp_program_list.php'); break;
				case 'User'    : title_wfunc('userid', 'kapp_program_list.php'); break;
				case 'Program' : title_wfunc('pg_name', 'kapp_program_list.php'); break;
				case 'Table'   : title_wfunc('tab_hnm', 'kapp_program_list.php'); break;
				case 'Date'    : title_wfunc('upday', 'kapp_program_list.php'); break;
				default        : title_wfunc('', 'kapp_program_list.php'); break;
		}
	});
 ...
 <?php
	...
	if( $mode == 'Program_Search' ) {
		...
		if( $project_code !='') $ls = $ls . " and group_code= '".$project_code."' ";
...
<div>
		<SELECT name="kproject" id="kproject" onChange="kproject_func(this.value, 'kapp_program_list.php')" style="background-color:cyan;color:#000;height:24;">
...
<?php } ?>
		...
		<input type="button" value="Search" onclick="PGsearch_func('kapp_program_list.php')">
		- View Line:
		<SELECT id='line_cnt' name='line_cnt' onChange="kapp_line_cnt_submit('kapp_program_list.php')" style='height:20;'>
