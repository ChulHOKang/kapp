...
/* -------------------------------------------------------
   tkher_config_link.php : tkher_config.php KAPP  상수 선언
   call : tkher_db_lib.php
------------------------------------------------------- */
define('KAPP_VERSION_', 'KAPP_V1');
define('KAPP_TREE_VER_', '3.1');
define('KAPP_NOTE_VER_', '3.1');
define('KAPP_BOARD_VER_', '3.1');
...
/*
www.domain.com and domain.com  쿠키를 공유하려면 domain.com 과 같이 입력하세요.
*/
define('KAPP_COOKIE_DOMAIN',  '');
define('KAPP_DATA_DIR',       '');
...
if (KAPP_DOMAIN) {
    ...
    if (isset($tkher_path['url']))
        define('KAPP_URL', $tkher_path['url']);
    else
        define('KAPP_URL', '');
}
