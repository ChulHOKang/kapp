...
define('KAPP_BOARD_VER_', '1.0'); //define('_KAPP_', true); // _KAPP_
...
define('KAPP_DATA_DIR',       $tkher_iurl . '/data'); //KAPP_URL_
...
*/
define('KAPP_CSS_URL',        $tkher_iurl.'/'.KAPP_CSS_DIR);
define('KAPP_DATA_URL',       './' );
define('KAPP_IMG_URL',        $tkher_iurl.'/'.KAPP_IMG_DIR);
define('KAPP_JS_URL',         $tkher_iurl.'/'.KAPP_JS_DIR);
define('KAPP_PLUGIN_URL',     './' );
define('KAPP_MOBILE_URL',     $tkher_iurl.'/'.KAPP_MOBILE_DIR);

define('KAPP_DATA_PATH',      './' );
define('KAPP_LIB_PATH',       $tkher_ipath.'/'.KAPP_LIB_DIR);
define('KAPP_PLUGIN_PATH',    './'  );
define('KAPP_MOBILE_PATH',    $tkher_ipath.'/'.KAPP_MOBILE_DIR);
...
//------------------------------------------------------------------------------
define('KAPP_SET_DEVICE', 'both'); // both 설정 시 접속 기기에 따른 화면 보여짐
