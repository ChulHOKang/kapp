...
//		paging($link,$total,$page,$line_cnt); 

// list1
function Xpaging_img($link, $total, $page, $line_cnt, $page_num, $view_line, $view_count){
	if( !$total ) { return; }
...
function pagingD($link, $total, $page, $line_cnt, $page_num){
	if( !$total ) { return; }
	$total_page	= ceil($total/$line_cnt);
